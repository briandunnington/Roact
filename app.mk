...
APP_ZIP_FILE := $(ZIPREL)/$(APPNAME)_$(APP_VERSION).zip
...
# FIXME: if no .png files are found, outputs bogus "zip warning: zip file empty"
	@$(ECHO) "  >> creating application zip $(APP_ZIP_FILE) from $(SOURCEDIR)"
	@if [ -d $(SOURCEDIR) ]; then \
        cd src; \
